...
class MemoryStorage:
    ...
    def _initialize_hardcoded_data(self):
        ...
        self.drivers["driver_002"] = {
            "driver_id": "driver_002",
            "name": "Amit Singh",
            "phone_number": "+919123456790",
            "vehicle_type": "suv",
        ...
        self.drivers["driver_003"] = {
            "driver_id": "driver_003",
            "name": "Priya Sharma",
            "phone_number": "+919123456791",
            "vehicle_type": "hatchback",
            "vehicle_number": "DL-01-EF-9012",
            "is_online": True,
            "is_available": True,
            "current_location": {
                "latitude": 28.5355,
        ...
        self.drivers["driver_004"] = {
            "driver_id": "driver_004",
            "name": "Vikram Mehta",
            "phone_number": "+919123456792",
            "vehicle_type": "premium",
            "vehicle_number": "DL-01-GH-3456",
            "is_online": True,
            "is_available": False,  # Currently on a ride
            "current_location": {
                "latitude": 28.4595,
                "longitude": 77.0266,
                "timestamp": datetime.now().isoformat()
        ...
        self.drivers["driver_005"] = {
            "driver_id": "driver_005",
            "name": "Sneha Reddy",
            "phone_number": "+919123456793",
            "vehicle_type": "hatchback",
            "vehicle_number": "DL-01-IJ-7890",
            "is_online": False,
            "is_available": False,
            "current_location": {
                "latitude": 28.4089,
        ...
        self.drivers["driver_006"] = {
            "driver_id": "driver_006",
            "name": "Mohit Agarwal",
            "phone_number": "+919123456794",
            "vehicle_type": "sedan",
            "vehicle_number": "DL-01-KL-2345",
            "is_online": True,
            "is_available": True,
            "current_location": {
                "latitude": 28.5500,
        ...
        self.drivers["driver_007"] = {
            "driver_id": "driver_007",
            "name": "Kavita Nair",
            "phone_number": "+919123456795",
            "vehicle_type": "suv",
            "vehicle_number": "DL-01-MN-6789",
            "is_online": True,
            "is_available": True,
            "current_location": {
                "latitude": 28.4800,
        ...
        self.drivers["driver_008"] = {
            "driver_id": "driver_008",
            "name": "Rohit Malhotra",
            "phone_number": "+919123456796",
            "vehicle_type": "premium",
            "vehicle_number": "DL-01-OP-0123",
            "is_online": True,
            "is_available": True,
            "current_location": {
                "latitude": 28.6200,
        ...
        self.drivers["driver_009"] = {
            "driver_id": "driver_009",
            "name": "Deepika Iyer",
            "phone_number": "+919123456797",
            "vehicle_type": "hatchback",
            "vehicle_number": "DL-01-QR-4567",
            "is_online": True,
            "is_available": True,
            "current_location": {
                "latitude": 28.6700,
        ...
        self.drivers["driver_010"] = {
            "driver_id": "driver_010",
            "name": "Arjun Kapoor",
            "phone_number": "+919123456798",
            "vehicle_type": "sedan",
            "vehicle_number": "DL-01-ST-8901",
            "is_online": True,
            "is_available": True,
            "current_location": {
                "latitude": 28.5800,
